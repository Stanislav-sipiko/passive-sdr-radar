 # Практическая схема 1→4 фазированного (in-phase) делителя 
...
Вход (port 1) — центральный вход делителя.
...
Измеряем фазу между выходами — должны быть равны (in-phase); разница фазы < ±10° желательна, < ±5° — отлично.
